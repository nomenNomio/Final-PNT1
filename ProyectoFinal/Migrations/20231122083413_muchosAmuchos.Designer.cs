...
namespace ProyectoFinal.Migrations
{
    ...
    [Migration("20231122083413_muchosAmuchos")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CuentaMascota", b =>
                {
                    ...
                    b.HasKey("CuentasId", "MascotasId");

                    b.HasIndex("MascotasId");

                    b.ToTable("CuentaMascotas", (string)null);
                });

            modelBuilder.Entity("CuentaRefugio", b =>
                {
                    b.Property<int>("CuentasId")
                        .HasColumnType("int");

                    b.Property<int>("RefugiosId")
                        .HasColumnType("int");

                    b.HasKey("CuentasId", "RefugiosId");

                    b.HasIndex("RefugiosId");

                    b.ToTable("CuentaRefugios", (string)null);
                });
            ...
            modelBuilder.Entity("CuentaMascota", b =>
                {
                    ...
                    b.HasOne("ProyectoFinal.Models.Mascota", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CuentaRefugio", b =>
                {
                    ...
                    b.HasOne("ProyectoFinal.Models.Refugio", null)
                        .WithMany()
                        .HasForeignKey("RefugiosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
